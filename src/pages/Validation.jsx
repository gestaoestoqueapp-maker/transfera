          ...
          Object.keys(counts).forEach(barcode => {
            if (!base[barcode]) {
              allErrors.push({
                line: '-',
                value: barcode,
                reason: 'Codigo nao encontrado na base',
  ...
  return (
    <div className="page">
        ...
        <div className="error-banner">
            ...
            {errors.length <= 10
              ...
              : (
                <button
                  ...
                  style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#791F1F', fontWeight: 500, fontSize: 13, textDecoration: 'underline' }}
                >
          ...
          {errors.length > 10 && !showAll && (
            <button
              ...
              style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#A32D2D', fontSize: 12, marginTop: 6, textDecoration: 'underline' }}
            >
      ...
      <div style={{ fontSize: 13, color: 'var(--text-secondary)', lineHeight: 1.5, marginTop: 8 }}>
        {errors.length > 0
          ? 'Itens ignorados nao entram no calculo. Um resumo aparecera ao exportar.'
          : 'Prossiga para configurar a cobertura minima.'
        }
      </div>
